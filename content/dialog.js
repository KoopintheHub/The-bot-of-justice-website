...
function displayDialog(width, height, string, buttonNum) {
  if (!darken) {
    ...
    darkenEl.style = "pointer-events: all; background: rgba(0,0,0,0.5); width: " + width + "%; height: " + height + "%; position: fixed; top: 0px; left: 0px; z-index: 15;";
    ...
    /* darkenEl.style = "pointer-events: none; background: rgba(0,0,0,0); width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 15;";
    darkenEl.innerHTML = ""; */
    $('#darken').fadeOut(150);
  }
}
